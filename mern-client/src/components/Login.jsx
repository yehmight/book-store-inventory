          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="divide-y divide-gray-200">
              <form onSubmit={handleLogin} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <p>
                  If you dont have an account, please <Link to="/sign-up" className="text-blue-600
                  underline ">Sign Up</Link> here
                </p>
                <div className="relative">
            ...
            <button onClick={handleSignIn} className='block'><img src={googleLogo} alt='' className='w-12 h-12 inline-block'/>Login with Google</button>
            </div>
          </div>
        </div>
      </div>
