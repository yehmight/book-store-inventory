...
const ManageBooks = () => {
  ...
  useEffect( () => {
    fetch("https://book-store-inventory.onrender.com/all.books").then(res => res.json()).then(data => setAllBooks(data));
  },[])

  // delete a books
  const handleDelete = (id) =>{
    console.log(id);
    fetch( `https://book-store-inventory.onrender.com/book/${id}`, {
      method: "DELETE",
